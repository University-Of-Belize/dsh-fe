...
<div
	class="select flex w-full flex-1 cursor-pointer select-none items-center justify-between rounded-sm bg-COLORLIGHT-100 bg-opacity-90 px-4 py-2 text-sm text-COLORLIGHT-100 text-COLORLIGHT-100 hover:bg-opacity-80 {custom_style}"
>
