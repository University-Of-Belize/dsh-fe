...
<main class="p-8 text-COLORLIGHT-100">
	<div class="mb-2 mt-6 text-2xl font-semibold">Testing is paused</div>
	<div
		bind:this={terminal}
		class="consoleEventLog block w-full rounded-sm border border-COLORLIGHT-100 p-8 font-mono text-COLORACCENTD"
	>
